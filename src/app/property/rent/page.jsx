    ...
    <main className={`min-h-screen font-serif ${bg}`}>
      ...
      <div className={`py-16 px-4 text-center ${dark ? "bg-zinc-950" : "bg-zinc-800"}`}>
        ...
        <h1 className="text-white text-3xl md:text-5xl font-black uppercase tracking-widest mt-2 mb-3">
          List Your<span className="block text-[#facc15]">Property for Rent</span>
        </h1>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <div className="flex mb-10 overflow-x-auto">
            {steps.slice(0,4).map((s, i) => (
              <div key={i} className="flex-1 flex items-center min-w-max">
                ...
                {i < 3 && <div className={`flex-1 h-px mx-2 ${step > i+1 ? "bg-[#facc15]" : dark ? "bg-zinc-800" : "bg-zinc-200"}`} />}
              </div>
            ))}
          </div>
        )}
        ...
        {step === 5 && (
          <div className={`border rounded-sm p-10 text-center space-y-4 ${card}`}>
            ...
            <h2 className="text-xl font-black uppercase tracking-tight text-[#facc15]">Rental Listing Submitted!</h2>
            ...
            <div className="flex gap-3 pt-2">
              <a href="/property/rent" className="flex-1 py-3 bg-[#facc15] text-black font-black uppercase text-[10px] tracking-widest hover:bg-yellow-400 transition-all text-center">Browse Rentals</a>
