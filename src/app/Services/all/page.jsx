...
const allServices = [
  ...
  {
    id: 4,
    slug: "interior-structural-solutions",
    title: "Interior & Structural Solutions",
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          {allServices.map((service) => (
            <div
              key={service.id}
              className={`group relative h-[500px] overflow-hidden border transition-all duration-500 ${
            ...
            >
              ...
              <div className="absolute inset-0 p-10 flex flex-col justify-end translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <Link
                  ...
                  className="w-fit px-8 py-3 bg-[#facc15] text-black font-black uppercase text-[10px] tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-500 hover:bg-white"
                >
                  Learn More
                </Link>
              </div>
