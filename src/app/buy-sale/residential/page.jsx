    ...
    <main className={`min-h-screen ${dark ? "bg-black" : "bg-gray-50"}`}>
      ...
      <div className={`relative py-16 px-4 text-center ${dark ? "bg-zinc-900" : "bg-zinc-800"}`}>
        ...
        <div className="flex items-center justify-center gap-2 mt-4 text-[10px] font-black uppercase tracking-widest">
          <Link href="/" className="text-zinc-500 hover:text-[var(--brand-blue)] transition-colors">Home</Link>
          <span className="text-zinc-700">›</span>
          <Link href="/buy-sale" className="text-zinc-500 hover:text-[var(--brand-blue)] transition-colors">Buy and Sale</Link>
          <span className="text-zinc-700">›</span>
          <span className="text-[var(--brand-blue)]">Residential</span>
        </div>
      </div>
