...
export default function PortfolioProjectCard({
  ...
  const image = project.image_url || project.image || project.img;
  const meta = [project.category || project.type, project.location || project.area].filter(Boolean).join(" · ");
  ...
  return (
    ...
    >
      <Link
        ...
        aria-label={`View ${project.title || project.name || "project"}`}
      >
