...
const statusColors = {
  ...
  "Upcoming Tender": { dark: "bg-sky-500/10 text-[var(--brand-blue-light)] border-[var(--brand-blue)]/20", light: "bg-sky-50 text-[var(--brand-blue-deep)] border-sky-100" },
      ...
      <section className="relative flex items-center justify-center text-center py-24 px-6"
        ...
        <div ref={heroRef} className="relative z-10 max-w-3xl mx-auto"
          ...
          <h1 className="text-4xl sm:text-6xl font-black uppercase text-white mb-4 tracking-tighter">
            Government &
            <span className="block text-[var(--brand-blue)]">Private Buildings</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`p-6 rounded-sm border mb-8 ${dark ? "bg-zinc-900 border-zinc-800" : "bg-white border-gray-100 shadow-sm"}`}>
          <div className="flex items-center justify-between mb-5">
            <h2 className={`text-xs font-black uppercase tracking-widest ${dark ? "text-[var(--brand-blue)]" : "text-zinc-800"}`}>Filter Buildings</h2>
        ...
        <p className={`text-xs font-black uppercase tracking-widest mb-6 ${dark ? "text-zinc-500" : "text-zinc-400"}`}>
          Showing <span className={dark ? "text-[var(--brand-blue)]" : "text-zinc-800"}>{filtered.length}</span> Buildings
        </p>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {filtered.map((b) => (
              <div key={b.id} className={`group rounded-sm overflow-hidden border transition-all duration-300 hover:shadow-xl flex flex-col md:flex-row ${dark ? "bg-zinc-900 border-zinc-800 hover:border-[var(--brand-blue)]" : "bg-white border-gray-100 hover:border-zinc-300 shadow-sm"}`}>
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    ...
                    <span className={`px-2 py-1 text-[9px] font-black uppercase tracking-widest rounded-sm flex-shrink-0 ${b.transaction === "Tender" ? "bg-blue-600 text-white" : b.transaction === "Sale" ? "bg-[var(--brand-blue)] text-black" : "bg-purple-500 text-white"}`}>
                      {b.transaction}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className={`py-2.5 text-[10px] font-black uppercase tracking-widest border-2 rounded-sm transition-all duration-300 ${dark ? "border-[var(--brand-blue)] text-[var(--brand-blue)] hover:bg-[var(--brand-blue)] hover:text-black" : "border-zinc-800 text-zinc-800 hover:bg-zinc-800 hover:text-white"}`}
                  >
        ...
        <div className={`mt-16 p-8 rounded-sm border ${dark ? "bg-zinc-900 border-zinc-800" : "bg-white border-gray-100 shadow-sm"}`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <span className="text-[var(--brand-blue)] text-[10px] font-black uppercase tracking-widest block mb-2">Need Tender Support?</span>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="px-8 py-3.5 bg-[var(--brand-blue)] text-black text-[10px] font-black uppercase tracking-widest hover:bg-[var(--brand-blue-dark)] transition-all rounded-sm"
              >
                Get Tender Support
              </button>
              <Link href="/contact" className={`px-8 py-3.5 text-center border-2 text-[10px] font-black uppercase tracking-widest transition-all rounded-sm ${dark ? "border-zinc-700 text-zinc-300 hover:border-[var(--brand-blue)] hover:text-[var(--brand-blue)]" : "border-gray-200 text-zinc-600 hover:border-zinc-800 hover:text-zinc-800"}`}>
                Talk to Our Team
              </Link>
            </div>
          </div>
      ...
      <section className={`py-20 px-6 transition-colors duration-500 ${dark ? "bg-zinc-900" : "bg-white"}`}>
        ...
        >
          <div className="text-center mb-14">
            <span className="text-[var(--brand-blue)] text-[10px] font-black uppercase tracking-[0.4em] block mb-2">Our Track Record</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={i} className={`group p-5 rounded-sm border transition-all duration-300 hover:border-[var(--brand-blue)] ${dark ? "bg-zinc-800 border-zinc-700 hover:bg-zinc-700" : "bg-gray-50 border-gray-100 hover:bg-white hover:shadow-md"}`}>
                <span className="text-2xl block mb-3">{b.icon}</span>
                <h3 className={`text-xs font-black uppercase tracking-widest mb-1.5 group-hover:text-[var(--brand-blue)] transition-colors ${dark ? "text-white" : "text-zinc-800"}`}>{b.title}</h3>
